...
max_income_multiple = 5  # x axis max - largest estate size we chart, as multiple of average earnings
y_axis_ticks = max_income_multiple / 10
income_resolution = 0.1  # the steps we go up
...
layout = go.Layout(
    images=logo_layout,
    title="Gross wage (as multiple of average earnings) vs effective income tax/SS/NICs rate",
    xaxis=dict(
